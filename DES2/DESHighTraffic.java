...
//cherry emerson
        ...
        Map<Integer, Integer> passengerTraffic = new HashMap<>(); 
            ...
            DataExport.writeBusStopDataToCSV(allBusStops, "BusStopsHighTraffic" + i + ".csv");   
            ArrayList<ArrayList<Passenger>> deadPassengers = Passenger.getDeadPassengers();
            DataExport.writePassengerDataToCSV(deadPassengers, "PassengersHighTraffic" + i + ".csv");
            if (!visualized) {
