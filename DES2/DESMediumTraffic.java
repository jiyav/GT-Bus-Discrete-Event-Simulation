...
//cherry emerson
        ...
        Map<Integer, Integer> passengerTraffic = new HashMap<>(); 
            ...
            DataExport.writeBusStopDataToCSV(allBusStops, "BusStopsMediumTraffic" + i + ".csv");   
            ArrayList<ArrayList<Passenger>> deadPassengers = Passenger.getDeadPassengers();
            DataExport.writePassengerDataToCSV(deadPassengers, "PassengersMediumTraffic" + i + ".csv");
            if (!visualized) {
