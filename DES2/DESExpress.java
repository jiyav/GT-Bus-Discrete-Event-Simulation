...
//cherry emerson
        ...
        ArrayList<RouteNode> expressRed = Utility.toExpress(redRoute, .5);

        Map<String, ArrayList<RouteNode>> routes = new HashMap<>(); 
        routes.put("Red", redRoute);
        routes.put("ExpressRed", expressRed);
        ...
        Bus express = new Bus("expressred", "ExpressRed", expressRed);
        express.init("ExpressRed");
