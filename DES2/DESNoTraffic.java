...
//cherry emerson
        ...
        Map<Integer, Double> trafficIndex = new HashMap<Integer, Double>(); 
            ...
            trafficIndex.put(7, 1.0);
            trafficIndex.put(8, 1.0);
            trafficIndex.put(9, 1.0);
            trafficIndex.put(10, 1.0);
            trafficIndex.put(11, 1.0);
            trafficIndex.put(12, 1.0);
            trafficIndex.put(13, 1.0);
            trafficIndex.put(14, 1.0);
            trafficIndex.put(15, 1.0);
            trafficIndex.put(16, 1.0);
            trafficIndex.put(17, 1.0);
            trafficIndex.put(18, 1.0);
            trafficIndex.put(19, 1.0);//7pm    
        ...
        Map<Integer, Integer> passengerTraffic = new HashMap<>(); 
            ...
            passengerTraffic.put(7, 5);
            passengerTraffic.put(8, 5);
            passengerTraffic.put(9, 5);
            passengerTraffic.put(10, 5);
            passengerTraffic.put(11, 5);
            passengerTraffic.put(12, 5);
            passengerTraffic.put(13, 5);
            passengerTraffic.put(14, 5);
            passengerTraffic.put(15, 5);
            passengerTraffic.put(16, 5);
            passengerTraffic.put(17, 5);
            passengerTraffic.put(18, 5);
            passengerTraffic.put(19, 5);//7pm    
           ...
           // }
            ...
            DataExport.writeBusStopDataToCSV(allBusStops, "BusStopsLowTraffic" + i + ".csv");   
            ArrayList<ArrayList<Passenger>> deadPassengers = Passenger.getDeadPassengers();
            DataExport.writePassengerDataToCSV(deadPassengers, "PassengersLowTraffic" + i + ".csv");
            if (!visualized)
